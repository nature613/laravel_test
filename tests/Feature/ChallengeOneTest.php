...
class ChallengeOneTest extends TestCase
{
    ...
    public function testCreateControllerFailsWithInvalidData()
    {
        ...
        $this->assertEquals($response->getContent(), '{"message":"The given data was invalid.","errors":{"email":["The email must be a string.","The email must be a valid email address."],"password":["The password must be a string."]}}');
    }
}
